...
### <Icon icon="slack" iconType="solid" /> Slack Integration 2.0
...
### <Icon icon="computer" iconType="solid" /> Use Devin’s Editor and Shell
...
### <Icon icon="rotate-left" iconType="solid" /> Rollback
...
### <Icon icon="comment-pen" iconType="solid" /> Live Playbook Editing
...
### <Icon icon="pen" iconType="solid" /> Playbook Editing
...
<video
  ...
  src="/images/rn_playbook_editing.mp4"
></video>
...
### <Icon icon="ban" iconType="solid" /> Forbidden Actions Reliability
...
### <Icon icon="house" iconType="solid" /> Home Screen Upgrades & Shortcuts
...
### <Icon icon="chart-simple" iconType="solid" /> PR Metrics Dashboard
...
### <Icon icon="cookie" iconType="solid" /> Cookies + Persisted Secrets
