...
<AccordionGroup>
  ...
  <Accordion title="Build a personal website" icon="browser">
    ```
  ...
  <Accordion title="Devin self-hosts Redash" icon="server">
    ```
    Hi Devin - I want to test out Redash. Please self host the Redash server, connect a local sqlite database. Add some dummy data and create an example query & dashboard.
    ```
  </Accordion>

  <Accordion title="Place an order on DoorDash" icon="burger">
    ```
    ## Overview
