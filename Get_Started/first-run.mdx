...
We’ve seen users build voice transcription apps, fine-tuned LLM apps, data analysis apps, scraping apps and more. Building web apps are a great way to start getting to know Devin.
...
**Set up [nfoert/cardie](https://github.com/nfoert/cardie) for local development and testing**
