...
2. Go to the menu on the top right hand corner of Devin’s Workspace and select [Use Devin’s Machine](Collaborate with Devin/machine). 
...
## Create a Machine Snapshot
    ...
    1. Once the installation is complete, go back to the Devin session where you installed the repo  and click the “**Create machine snapshot**” button in the bottom right corner.
        ...
        A [snapshot](Onboard Devin/snapshots) allows you to initialize new Devin instances from the snapshotted machine image. This will let you skip the installation steps going forward.
...
<Info>Check out the [Machine Snapshots](Onboard Devin/snapshots) guide for more information</Info>
