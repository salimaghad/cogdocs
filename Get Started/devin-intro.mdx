...
description: "Devin is the first autonomous AI software engineer"
---

<Frame>
    ![Devin](/images/devin_session.png)
</Frame>
...
<Frame>
    ![Devin](/images/editor_view.png)
</Frame>

In Devin’s Workspace, you’ll find: 

<CardGroup cols={2}>
  <Card title="Shell" icon="square-1">
    a text-based interface where Devin can input commands that interact directly with a computer's operating system.
  </Card>
  <Card title="Browser" icon="square-2">
    watch Devin browse through documentation, navigate through websites, download/upload upload information, and jump in to help Devin navigate thorough browsing tasks.
  </Card>
  <Card title="Editor" icon="square-3">
    this is where Devin will write code. Here you can supervise, review and edit (see our [VSCode Guide](https://www.notion.so/bd89720db24e4f52bcd63489ff87e3fa?pvs=21)) the code Devin is writing.
  </Card>
  <Card title="Planner" icon="square-4">
...
<Frame>
    ![Devin](/images/workspace_grid.png)
</Frame>
...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/watch?v=fjHtjT7GO1c"
