...
<Accordion title="Edit while the session is running" icon="wave-pulse">
...
<Accordion title="Check out file diffs" icon="file-plus-minus">
...
<Accordion title="Keep Devin a heads up when making edits" icon="circle-info">
...
<Accordion title="Help Devin on the last mile" icon="flag-checkered">
